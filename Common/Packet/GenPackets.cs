...
class TestPacket : IPacket
{
    ...
    public ushort Protocol { get { return (ushort)PacketID.TestPacket; } }
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.TestPacket);
        count += sizeof(ushort);
